    ...
    <section id="contact" className="py-16 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold text-amber-800 mb-2">Visit Us</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div className="bg-amber-50 p-8 rounded-lg shadow-md">
            <h3 className="text-xl font-semibold text-amber-900 mb-6">Contact Information</h3>
            
            <div className="space-y-4">
              <div className="flex items-start">
                <MapPin className="text-amber-800 mr-3 h-5 w-5 mt-0.5" />
                <div>
              ...
              <div className="flex items-start">
                <Clock className="text-amber-800 mr-3 h-5 w-5 mt-0.5" />
                <div>
              ...
              <div className="flex items-start">
                <Phone className="text-amber-800 mr-3 h-5 w-5 mt-0.5" />
                <div>
              ...
              <div className="flex items-start">
                <Mail className="text-amber-800 mr-3 h-5 w-5 mt-0.5" />
                <div>
            ...
            <div className="mt-8">
              <h3 className="text-xl font-semibold text-amber-900 mb-4">Connect With Us</h3>
