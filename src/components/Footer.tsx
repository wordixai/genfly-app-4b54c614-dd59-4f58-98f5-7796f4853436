        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="mb-4 text-amber-200">
              A cozy spot to enjoy artisanal coffee and delicious pastries in a welcoming atmosphere.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <MapPin className="text-amber-300 mr-3 h-5 w-5 mt-0.5" />
                <span>123 Coffee Street, Brewville, CA 90210</span>
              </li>
              <li className="flex items-start">
                <Phone className="text-amber-300 mr-3 h-5 w-5 mt-0.5" />
                <span>(555) 123-4567</span>
              </li>
              <li className="flex items-start">
                <Mail className="text-amber-300 mr-3 h-5 w-5 mt-0.5" />
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                <Clock className="text-amber-300 mr-3 h-5 w-5 mt-0.5" />
                <div>
